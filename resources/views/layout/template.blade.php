...
<html>
	<head>
		<title>SMKN1 | {{$page}}</title>
		<link rel="stylesheet" href="{{ asset('assets/css/bootstrap.min.css') }}">
		<link rel="shortcut icon" href="{{ asset('assets/img/smk1.ico') }}">
		</head>
	<body>
		<header>
			<nav class="navbar navbar-expand-lg navbar-light bg-light">
			  <div class="container-fluid">
			    <a class="navbar-brand" href="#">SMKN 1</a>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{asset('template')}}/index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">SMKN 1</span>
    </a>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/">SMKN1</a></li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019-2021 Arkan.</strong> All rights reserved.
  </footer>
